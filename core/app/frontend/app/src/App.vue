    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
      ...
      <div v-else class="flex items-center justify-between">
        ...
        <div v-if="isConnected" class="flex items-center space-x-3">
          <a :href="`${baseUrl}/dashboard`" target="_blank" class="px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors duration-200 flex items-center space-x-2">
